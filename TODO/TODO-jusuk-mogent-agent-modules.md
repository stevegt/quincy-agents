...
- [ ] jusuk.1 Project scaffolding - Go module, CLI skeleton, basic build
- [ ] jusuk.2 TOML parser - Parse AGENTS.toml with categories, tags, sources
- [ ] jusuk.3 Module parser - Parse markdown with header attribute tags {#tag1 #tag2}
- [ ] jusuk.4 Tag resolver - Hierarchical tag matching with parent-implies-children
- [ ] jusuk.5 Assembly engine - Combine modules based on active scopes
- [ ] jusuk.6 Build command - mogent build outputs AGENTS.md
- [ ] jusuk.7 Edit command - mogent edit <module> and mogent edit (assembled)
- [ ] jusuk.8 Diff command - Section-aware diff between scopes
- [ ] jusuk.9 List command - List available and active modules
- [ ] jusuk.10 Dogfood - Use mogent on this repo's AGENTS.md
